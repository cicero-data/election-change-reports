...
SELECT  c.id, c.label, c.name_formal, c.official_count, c.election_frequency, c.term_length
 ...
 GROUP BY c.id, c.label  c.name_formal, c.official_count, c.election_frequency, c.term_length ),
